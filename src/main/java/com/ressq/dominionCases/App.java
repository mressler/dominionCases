...
public class App 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		// Load resources
		PDFont trajan = loadFontResource(masterDoc, "Trajan Pro Regular.ttf");
		PDFont barbedor = loadFontResource(masterDoc, "Barbedor Regular.ttf");
		
		DominionImageRepository imageRepo = new DominionImageRepository(
