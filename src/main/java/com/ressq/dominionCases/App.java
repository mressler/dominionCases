...
public class App 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		URL barbedorUrl = getResource("Barbedor Regular.ttf");
		PDFont barbedor = PDType0Font.load(masterDoc, barbedorUrl.openStream());
